...
var MongoRepository = /** @class */ (function () {
    ...
    MongoRepository.prototype.insertProduct = function (newProduct) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, product_schema_1.ProductModel.create(newProduct)];
                    case 1:
    ...
    MongoRepository.prototype.deleteProduct = function (_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, product_schema_1.ProductModel.deleteOne({ _id: new mongoose_1.default.Types.ObjectId(_id) })];
                    case 1:
                ...
                switch (_h.label) {
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, Promise.all(product.depots_ids.map(function (depot_id) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0: return [4 /*yield*/, depot_schema_1.DepotModel.findOne({ _id: depot_id }, { name: 1, seller_id: 1 })];
                                        case 1:
                                            depot = _b.sent();
                                            _a = product;
