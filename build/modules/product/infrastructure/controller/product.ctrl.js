...
var product_value_1 = require("../../domain/product.value");
var ProductController = /** @class */ (function () {
    function ProductController(productService) {
        ...
        this.getProducts = function (_a, res) {
            var body = _a.body;
            return __awaiter(_this, void 0, void 0, function () {
                var depots, arrayDepots, products;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            depots = body.depots;
                            arrayDepots = JSON.parse(depots);
                            return [4 /*yield*/, this.productService.getProducts(arrayDepots)];
                        case 1:
                            products = _b.sent();
                            res.send(products);
                            return [2 /*return*/];
        ...
        this.deleteProduct = function (_a, res) {
            var params = _a.params;
            return __awaiter(_this, void 0, void 0, function () {
                var _id, deletedProduct;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _id = params._id;
                            return [4 /*yield*/, this.productService.deleteProduct(_id)];
                        case 1:
