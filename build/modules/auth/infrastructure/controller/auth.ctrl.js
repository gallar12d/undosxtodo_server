...
var AuthController = /** @class */ (function () {
    function AuthController(userService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.userService.userExist(req.body.email)];
                    case 1:
                        exist = _a.sent();
                        if (exist)
        ...
        this.loginUser = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.loginUser(req.body.email, req.body.password)];
                    case 1:
                        user = _a.sent();
                        if (!user)
