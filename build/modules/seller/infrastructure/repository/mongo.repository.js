...
var MongoRepository = /** @class */ (function () {
    ...
    MongoRepository.prototype.getSeller = function (id) {
    ...
    MongoRepository.prototype.createSeller = function (seller) {
        return __awaiter(this, void 0, void 0, function () {
            var sellerUpdated;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    MongoRepository.prototype.updateSeller = function (_a) {
        var id = _a.id, name = _a.name, country = _a.country, state = _a.state, city = _a.city, address = _a.address, telephone = _a.telephone, nit = _a.nit, postal_code = _a.postal_code, email = _a.email;
        return __awaiter(this, void 0, void 0, function () {
            var seller_id, sellerUpdated;
