...
var inventory_value_1 = require("../../domain/inventory.value");
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.inventoryService.getInventory()];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _c = (_b = res.status(200)).send;
                            return [4 /*yield*/, this.inventoryService.getRelatedDepots(seller_id)];
                        case 1:
                            _c.apply(_b, [_d.sent()]);
                            return [3 /*break*/, 3];
                        case 2:
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _d.trys.push([0, 2, , 3]);
                            depot_id = body.depot_id, seller_id = body.seller_id;
                            _c = (_b = res.status(200)).send;
                            return [4 /*yield*/, this.inventoryService.getProducts(depot_id, seller_id)];
                        case 1:
                            _c.apply(_b, [_d.sent()]);
                            return [3 /*break*/, 3];
                        case 2:
