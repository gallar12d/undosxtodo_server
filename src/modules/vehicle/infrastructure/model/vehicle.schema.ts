...
interface VehicleDocument extends mongoose.Document { ruta99_id }
const VehicleModel = mongoose.model<VehicleDocument, mongoose.PaginateModel<VehicleDocument>>('Vehicles', VehicleSchema, 'vehicles');
export { VehicleModel };